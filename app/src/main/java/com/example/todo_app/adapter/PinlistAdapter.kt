...
class PinlistAdapter(private val mCtx: Context, private var notelist: ArrayList<NotesApp>, var date:String, var callListerner:CallListerner) :


    RecyclerView.Adapter<PinlistAdapter.TasksViewHolder>() {
    var item:Int?=null
